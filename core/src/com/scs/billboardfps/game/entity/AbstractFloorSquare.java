...
public abstract class AbstractFloorSquare extends Entity {

	public ModelInstance instance;
	
	public AbstractFloorSquare(String name, String tex, int map_x, int map_y) {
		super(name);
		
		Material material = new Material(TextureAttribute.createDiffuse(new Texture(Gdx.files.internal(tex))));		
