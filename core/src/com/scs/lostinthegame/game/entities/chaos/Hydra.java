...
public class Hydra extends AbstractEntity {

    public Hydra(int x, int y) {
        super(Hydra.class.getSimpleName());

        PositionData pos = new PositionData();
        pos.position = new Vector3(x*Game.UNIT+(Game.UNIT/2), 0, y*Game.UNIT+(Game.UNIT/2));
        this.addComponent(pos);
        
        TextureRegion[][] trs = Art.createSheet("chaos/hydra.png", 4, 1);
        ...
        HasAI ai = new HasAI(Mode.GoForPlayerIfClose, 1.2f, Game.UNIT*7f);
