...
public class ChaosWraith extends AbstractEntity {

    public ChaosWraith(int x, int y) {
        super(ChaosWraith.class.getSimpleName());

        PositionData pos = new PositionData();
        pos.position = new Vector3(x*Game.UNIT+(Game.UNIT/2), 0, y*Game.UNIT+(Game.UNIT/2));
        this.addComponent(pos);
        
        TextureRegion[][] trs = Art.createSheet("chaos/chaoswraith.png", 4, 1);
